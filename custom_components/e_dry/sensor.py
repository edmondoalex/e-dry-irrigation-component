    ...
    def extra_state_attributes(self) -> Dict[str, Any]:
        ...
        if irrigation_weather:
            attrs.update({
                ...
                "rain_today_mm": irrigation_weather.get("rain_today_mm"),
                "forecast_rain_24h_mm": irrigation_weather.get("forecast_rain_24h_mm"),
                "et0_mm_day": irrigation_weather.get("et0_mm_day"),
                "wind_speed_ms": irrigation_weather.get("wind_speed_ms"),
                "wind_gust_ms": irrigation_weather.get("wind_gust_ms") or irrigation_weather.get("gust_ms") or irrigation_weather.get("wind_gust_speed_ms"),
                "solar_radiation_w_m2": irrigation_weather.get("solar_radiation_w_m2"),
                "uv_index": irrigation_weather.get("uv_index"),
                "vpd_hpa": irrigation_weather.get("vpd_hpa"),
                "dew_point_c": irrigation_weather.get("dew_point_c"),
                "station_installed": irrigation_weather.get("station_installed"),
                "station_detected": irrigation_weather.get("station_detected"),
